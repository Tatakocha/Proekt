<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Kabinet.aspx.cs" Inherits="Internet_Apteka.Kabinet" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <p>
        <asp:Label ID="Label2" runat="server" Font-Size="16pt" ForeColor="#000066" Height="34px" Width="497px">Ваши покупки</asp:Label>
</p>
    <div>
        <div>
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>"
                ...
                SelectCommand="SELECT * FROM [Orders] WHERE [user_id] = @user_id" 
                UpdateCommand="UPDATE [Orders] SET [order_date] = @order_date, [user_id] = @user_id WHERE [id_order] = @id_order">
                <DeleteParameters>
                ...
                <SelectParameters>
                    <asp:SessionParameter DefaultValue="" Name="user_id" 
                        SessionField="CurrentUserId" Type="Object" />
                </SelectParameters>
                <UpdateParameters>
                    <asp:Parameter Name="order_date" Type="DateTime" />
                    <asp:Parameter Name="user_id" Type="Object" />
            ...
            <p>
                <asp:Label ID="Label3" runat="server" Font-Size="16pt" ForeColor="#000066" Height="34px" Width="497px"></asp:Label>
            </p>

...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <p style="font-family: 'Times New Roman'; font-size: 16px; font-weight: normal; font-style: oblique; font-variant: normal; text-transform: capitalize; color: #000080; text-decoration: underline overline; background-color: #CCFFCC; background-position: center center; width: 874px;">
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Добро пожаловать в нашу аптеку! Для совершения заказа необходимо войти на сайт_____________________. _________________________________________________________&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </p>
    <div>
            ...
            <asp:LoginView ID="LoginView1" runat="server">
                ...
                <RoleGroups>
                    <asp:RoleGroup Roles="adminka,mods">
                        <ContentTemplate>
                            <asp:Button ID="MyKabinet" visible="false" />
                        </ContentTemplate>
                    </asp:RoleGroup>
                </RoleGroups>
            </asp:LoginView>
        ...
        <div>
            <p>
                <asp:Label ID="Label2" runat="server" Font-Size="16pt" ForeColor="#000066" Height="34px" Width="497px">Категории товаров:</asp:Label>
            </p>
            ...
            <asp:GridView ID="GridView1" runat="server" AllowSorting="True" DataSourceID="SqlDataSource1"
                ...
                onrowupdating="GridView1_RowUpdating" AllowPaging="True" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="914px">
                <Columns>
            ...
            <p>
                &nbsp;<asp:Label ID="Label1" runat="server" Font-Size="16pt" ForeColor="#000066" Height="34px" Width="735px"></asp:Label>
            </p>
